...
from apm.utils.comparator import operators
from apm.utils.exception import VersionRuleException
...
def install():
    ...
    for importer, modname, _ispkg in pkgutil.iter_modules(apm.plugins.__path__):
