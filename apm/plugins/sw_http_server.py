...
from apm import Layer, Component, config
from apm.trace.carrier import Carrier
from apm.trace.context import get_context, NoopContext
from apm.trace.span import NoopSpan
from apm.trace.tags import TagHttpMethod, TagHttpURL, TagHttpStatusCode
...
def wrap_werkzeug_request_handler(handler):
    """
    Wrap run_wsgi of werkzeug.serving.WSGIRequestHandler to add apm instrument code.
    """
