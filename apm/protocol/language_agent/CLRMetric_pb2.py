...
_CLRMETRICCOLLECTION = _descriptor.Descriptor(
  ...
  full_name='apm.v3.CLRMetricCollection',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='metrics', full_name='apm.v3.CLRMetricCollection.metrics', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='service', full_name='apm.v3.CLRMetricCollection.service', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='serviceInstance', full_name='apm.v3.CLRMetricCollection.serviceInstance', index=2,
...
_CLRMETRIC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='apm.v3.CLRMetric.time', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpu', full_name='apm.v3.CLRMetric.cpu', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='gc', full_name='apm.v3.CLRMetric.gc', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='thread', full_name='apm.v3.CLRMetric.thread', index=3,
...
_CLRGC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='Gen0CollectCount', full_name='apm.v3.ClrGC.Gen0CollectCount', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Gen1CollectCount', full_name='apm.v3.ClrGC.Gen1CollectCount', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='Gen2CollectCount', full_name='apm.v3.ClrGC.Gen2CollectCount', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='HeapMemory', full_name='apm.v3.ClrGC.HeapMemory', index=3,
...
_CLRTHREAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='AvailableCompletionPortThreads', full_name='apm.v3.ClrThread.AvailableCompletionPortThreads', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='AvailableWorkerThreads', full_name='apm.v3.ClrThread.AvailableWorkerThreads', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='MaxCompletionPortThreads', full_name='apm.v3.ClrThread.MaxCompletionPortThreads', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='MaxWorkerThreads', full_name='apm.v3.ClrThread.MaxWorkerThreads', index=3,
...
CLRMetricCollection = _reflection.GeneratedProtocolMessageType('CLRMetricCollection', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:apm.v3.CLRMetricCollection)
  })
...
CLRMetric = _reflection.GeneratedProtocolMessageType('CLRMetric', (_message.Message,), {
  ...
  '__module__' : 'language_agent.CLRMetric_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.CLRMetric)
  })
...
ClrGC = _reflection.GeneratedProtocolMessageType('ClrGC', (_message.Message,), {
  'DESCRIPTOR' : _CLRGC,
  '__module__' : 'language_agent.CLRMetric_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.ClrGC)
  })
...
ClrThread = _reflection.GeneratedProtocolMessageType('ClrThread', (_message.Message,), {
  ...
  '__module__' : 'language_agent.CLRMetric_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.ClrThread)
  })
...
_CLRMETRICREPORTSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='apm.v3.CLRMetricReportService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='collect',
    full_name='apm.v3.CLRMetricReportService.collect',
    index=0,
