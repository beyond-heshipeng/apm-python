...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='apm.v3',
  syntax='proto3',
  serialized_options=b'\n3org.apache.apm.apm.network.language.agent.v3P\001Z:apm.apache.org/repo/goapi/collect/language/agent/v3',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x1alanguage-agent/Meter.proto\x12\rapm.v3\x1a\x13\x63ommon/Common.proto\"$\n\x05Label\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t\"M\n\x10MeterBucketValue\x12\x0e\n\x06\x62ucket\x18\x01 \x01(\x01\x12\r\n\x05\x63ount\x18\x02 \x01(\x03\x12\x1a\n\x12isNegativeInfinity\x18\x03 \x01(\x08\"U\n\x10MeterSingleValue\x12\x0c\n\x04name\x18\x01 \x01(\t\x12$\n\x06labels\x18\x02 \x03(\x0b\x32\x14.apm.v3.Label\x12\r\n\x05value\x18\x03 \x01(\x01\"u\n\x0eMeterHistogram\x12\x0c\n\x04name\x18\x01 \x01(\t\x12$\n\x06labels\x18\x02 \x03(\x0b\x32\x14.apm.v3.Label\x12/\n\x06values\x18\x03 \x03(\x0b\x32\x1f.apm.v3.MeterBucketValue\"\xbe\x01\n\tMeterData\x12\x36\n\x0bsingleValue\x18\x01 \x01(\x0b\x32\x1f.apm.v3.MeterSingleValueH\x00\x12\x32\n\thistogram\x18\x02 \x01(\x0b\x32\x1d.apm.v3.MeterHistogramH\x00\x12\x0f\n\x07service\x18\x03 \x01(\t\x12\x17\n\x0fserviceInstance\x18\x04 \x01(\t\x12\x11\n\ttimestamp\x18\x05 \x01(\x03\x42\x08\n\x06metric\"B\n\x13MeterDataCollection\x12+\n\tmeterData\x18\x01 \x03(\x0b\x32\x18.apm.v3.MeterData2V\n\x12MeterReportService\x12@\n\x07\x63ollect\x12\x18.apm.v3.MeterData\x1a\x17.apm.v3.Commands\"\x00(\x01\x42s\n3org.apache.apm.apm.network.language.agent.v3P\x01Z:apm.apache.org/repo/goapi/collect/language/agent/v3b\x06proto3'
  ,
...
_LABEL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='apm.v3.Label.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='apm.v3.Label.value', index=1,
...
_METERBUCKETVALUE = _descriptor.Descriptor(
  ...
  full_name='apm.v3.MeterBucketValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='bucket', full_name='apm.v3.MeterBucketValue.bucket', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='count', full_name='apm.v3.MeterBucketValue.count', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='isNegativeInfinity', full_name='apm.v3.MeterBucketValue.isNegativeInfinity', index=2,
...
_METERSINGLEVALUE = _descriptor.Descriptor(
  ...
  full_name='apm.v3.MeterSingleValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='apm.v3.MeterSingleValue.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='labels', full_name='apm.v3.MeterSingleValue.labels', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='apm.v3.MeterSingleValue.value', index=2,
...
_METERHISTOGRAM = _descriptor.Descriptor(
  name='MeterHistogram',
  full_name='apm.v3.MeterHistogram',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='apm.v3.MeterHistogram.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='labels', full_name='apm.v3.MeterHistogram.labels', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='values', full_name='apm.v3.MeterHistogram.values', index=2,
...
_METERDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='singleValue', full_name='apm.v3.MeterData.singleValue', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='histogram', full_name='apm.v3.MeterData.histogram', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service', full_name='apm.v3.MeterData.service', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='serviceInstance', full_name='apm.v3.MeterData.serviceInstance', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='apm.v3.MeterData.timestamp', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='metric', full_name='apm.v3.MeterData.metric',
...
_METERDATACOLLECTION = _descriptor.Descriptor(
  ...
  full_name='apm.v3.MeterDataCollection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='meterData', full_name='apm.v3.MeterDataCollection.meterData', index=0,
...
Label = _reflection.GeneratedProtocolMessageType('Label', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:apm.v3.Label)
  })
...
MeterBucketValue = _reflection.GeneratedProtocolMessageType('MeterBucketValue', (_message.Message,), {
  ...
  '__module__' : 'language_agent.Meter_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.MeterBucketValue)
  })
...
MeterSingleValue = _reflection.GeneratedProtocolMessageType('MeterSingleValue', (_message.Message,), {
  ...
  '__module__' : 'language_agent.Meter_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.MeterSingleValue)
  })
...
MeterHistogram = _reflection.GeneratedProtocolMessageType('MeterHistogram', (_message.Message,), {
  ...
  '__module__' : 'language_agent.Meter_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.MeterHistogram)
  })
...
MeterData = _reflection.GeneratedProtocolMessageType('MeterData', (_message.Message,), {
  ...
  '__module__' : 'language_agent.Meter_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.MeterData)
  })
...
MeterDataCollection = _reflection.GeneratedProtocolMessageType('MeterDataCollection', (_message.Message,), {
  ...
  '__module__' : 'language_agent.Meter_pb2'
  # @@protoc_insertion_point(class_scope:apm.v3.MeterDataCollection)
  })
...
_METERREPORTSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='apm.v3.MeterReportService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='collect',
    full_name='apm.v3.MeterReportService.collect',
    index=0,
