...
# source: language-agent/MetricCompat.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='language-agent/MetricCompat.proto',
  package='',
  syntax='proto3',
  ...
  serialized_pb=b'\n!language-agent/MetricCompat.proto\x1a\x13\x63ommon/Common.proto\x1a\x1blanguage-agent/Metric.proto2\\\n\x13MetricReportService\x12\x45\n\x07\x63ollect\x12\x1f.skywalking.v3.MetricCollection\x1a\x17.skywalking.v3.Commands\"\x00\x42\x9d\x01\n:org.apache.skywalking.apm.network.language.agent.v3.compatP\x01Z:skywalking.apache.org/repo/goapi/collect/language/agent/v3\xb8\x01\x01\xaa\x02\x1dSkyWalking.NetworkProtocol.V3b\x06proto3'
  ,
  dependencies=[common_dot_Common__pb2.DESCRIPTOR,language__agent_dot_Metric__pb2.DESCRIPTOR,])
...
_METRICREPORTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='collect',
    full_name='MetricReportService.collect',
    index=0,
    containing_service=None,
    input_type=language__agent_dot_Metric__pb2._METRICCOLLECTION,
