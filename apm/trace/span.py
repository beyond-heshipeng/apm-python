...
from apm import Kind, Layer, Log, Component, LogItem, config
from apm.trace import ID
from apm.trace.carrier import Carrier
from apm.trace.segment import SegmentRef, Segment
from apm.trace.tags import Tag
from apm.utils.lang import tostring
...
class Span(ABC):
    ...
    def raised(self) -> 'Span':
        from apm.utils.filter import sw_traceback
